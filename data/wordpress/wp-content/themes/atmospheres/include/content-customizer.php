...
function atmospheres__customize_register_content( $wp_customize ) {
	
/**
 * Recent Posts
 */
		$wp_customize->add_section( 'seos_content_section' , array(
			'title'       => __( 'Content Options', 'atmospheres' ),
			'priority'    => 27,	
		 ...
		 $wp_customize->add_control( 'content_padding', array(
		  ...
		  'label' => __( 'Content Padding', 'atmospheres' ),
		  'input_attrs' => array(
			'min' => 0,
			'max' => 100,
			'step' => 1,
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_home_content', array(
			'label'    => __( 'Hide sidebar and content on home page', 'atmospheres' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_featured', array(
			'label'    => __( 'Show featured images on all single pages.', 'atmospheres' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'hide_page_titles', array(
			'label'    => __( 'Hide all single page and post titles', 'atmospheres' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'article_justify', array(
			'label'    => __( 'Article Text Align - Justify', 'atmospheres' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'article_shadow', array(
			'label'    => __( 'Activate Border Shadows', 'atmospheres' ),
			'section'  => 'seos_content_section',
			'priority'    => 1,				
...
add_action( 'customize_register', 'atmospheres__customize_register_content' );
/********************************************
* Content Styles
*********************************************/ 	
function atmospheres__content_styles () {
...
add_action( 'wp_enqueue_scripts', 'atmospheres__content_styles' );