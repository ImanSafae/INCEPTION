...
add_action( 'customize_register', 'atmospheres_color_scheme_customize' );
function atmospheres_color_scheme_customize( $wp_customize ) {

		$wp_customize->add_section( 'seos_color_scheme' , array(
			'title'       => __( 'Color Scheme', 'atmospheres' ),
			'priority'    => 25,
		) );
 		...
 		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'color_scheme', array(
			'label'    => __( 'Color Scheme', 'atmospheres' ),
			'priority' => 14,
 		...
 		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'color_scheme_hover', array(
			'label'    => __( 'Hover Color', 'atmospheres' ),
			'priority' => 14,
			'section'  => 'seos_color_scheme',
...
add_action( 'wp_enqueue_scripts', 'atmospheres_color_scheme' );	
function atmospheres_color_scheme() {
