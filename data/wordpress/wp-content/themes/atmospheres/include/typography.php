<?php
	...
	/******************************
		* Font Sanitize
	******************************/
	function atmospheres_array_fonts() {
		$array = array(
		'' => esc_attr__( 'inherit', 'atmospheres' ),		
		'Helvetica' => esc_attr__( 'Helvetica', 'atmospheres' ),
		'Arial' => esc_attr__( 'Arial', 'atmospheres' ),
		'Oswald' => esc_attr__( 'Oswald', 'atmospheres' ),
		'Verdana' => esc_attr__( 'Verdana', 'atmospheres' ),
		'Tahoma' => esc_attr__( 'Tahoma', 'atmospheres' ),
		'Trebuchet MS' => esc_attr__( 'Trebuchet MS', 'atmospheres' ),
		'Impact' => esc_attr__( 'Impact', 'atmospheres' ),
		'Times New Roman' => esc_attr__( 'Times New Roman', 'atmospheres' ),
		'Courier' => esc_attr__( 'Courier', 'atmospheres' ),
		);
		return $array;
	}
	function atmospheres_sanitize_fonts( $input ) {
		$valid = atmospheres_array_fonts();
	...
	/******************************
		* Font Wight Sanitize
	******************************/
	function atmospheres_array_font_weight() {
		$array = array(
		'' => esc_attr__( 'Inherit', 'atmospheres' ),		
		'100' => esc_attr__( 'Thin 100', 'atmospheres' ),
		'200' => esc_attr__( 'Extra Light 200', 'atmospheres' ),
		'300' => esc_attr__( 'Light 300', 'atmospheres' ),
		'400' => esc_attr__( 'Normal 400', 'atmospheres' ),
		'500' => esc_attr__( 'Medium 500', 'atmospheres' ),
		'600' => esc_attr__( 'Semi Bold 600', 'atmospheres' ),
		'700' => esc_attr__( 'Bold 700', 'atmospheres' ),
		'800' => esc_attr__( 'Extra Bold 800', 'atmospheres' ),
		'900' => esc_attr__( 'Ultra Bold 900', 'atmospheres' ),
		);
		return $array;
	}
	function atmospheres_sanitize_fonts_weight( $input ) {
		$valid = atmospheres_array_font_weight();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	function atmospheres_array_text_transform() {
		$array = array(
		'inherit' => esc_attr__( 'Inherit', 'atmospheres' ),		
		'' => esc_attr__( 'None', 'atmospheres' ),
		'capitalize' => esc_attr__( 'Capitalize', 'atmospheres' ),
		'uppercase' => esc_attr__( 'Uppercase', 'atmospheres' ),
		'lowercase' => esc_attr__( 'Lowercase', 'atmospheres' ),
		);
		return $array;
	}
	function atmospheres_sanitize_text_transform( $input ) {
		$valid = atmospheres_array_text_transform();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	...
	function atmospheres_array_font_style() {
		$array = array(
		'inherit' => esc_attr__( 'Inherit', 'atmospheres' ),		
		'italic' => esc_attr__( 'Italic', 'atmospheres' ),
		);
		return $array;
	}
	function atmospheres_sanitize_font_style( $input ) {
		$valid = atmospheres_array_font_style();
		if ( array_key_exists( $input, $valid ) ) {
			return $input;
			} else {
			return '';
	...
	******************************/
	...
	function atmospheres_sanitize_float( $input ) {
		return filter_var($input, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION);
	}
	
	add_action( 'customize_register', 'atmospheres_typography_customize' );
	function atmospheres_typography_customize( $wp_customize ) {
		
		$wp_customize->add_panel( 'seos_typography_panel' , array(
		'title'       => __( 'Typography', 'atmospheres' ),
		'priority'    => 6,
		) );
		...
		'title'       => __( 'Site Title', 'atmospheres' ),
		'priority'    => 1,
		) );
		...
		******************************/		
		...
		'label'       => __( 'Font Size / px', 'atmospheres' ),
		'description' => __( 'When the range is null, the default value is set.', 'atmospheres' ),		
		'type'     =>  'range',
		'input_attrs'     => array(
		'min'  => 0,
		'max'  => 100,
		...
		******************************/		
		...
		'label'       => __( 'Mobile Font Size / px', 'atmospheres' ),
		'description' => __( 'When the range is null, the default value is set.', 'atmospheres' ),		
		'type'     =>  'range',
		'input_attrs'     => array(
		'min'  => 0,
		...
		******************************/
		...
		'sanitize_callback' => 'atmospheres_sanitize_float',
		) );
		...
		'section'  => 'typography_site_title',
		'label'       => __( 'Line Hight / em', 'atmospheres' ),
		'description' => __( 'When the range is null, the default value is set.', 'atmospheres' ),		
		'input_attrs' => array(
		'min'  => 0,
		'max'  => 5,
		...
		******************************/		
		...
		'priority' => 9,
		'section' => 'typography_site_title',
		'label'       => __( 'Letter Spacing / px', 'atmospheres' ),
		'description' => __( 'When the range is null, the default value is set.', 'atmospheres' ),			
		'input_attrs' => array(
		'min'  => 0,
		'max'  => 10,
		...
		'panel'       => "seos_typography_panel",
		'title'       => __( 'Site Description', 'atmospheres' ),
		'priority'    => 1,
		) );
		/******************************
			* Font
	...
	add_action( 'wp_enqueue_scripts', 'atmospheres_typography_styles' );	
	function atmospheres_typography_styles() {
