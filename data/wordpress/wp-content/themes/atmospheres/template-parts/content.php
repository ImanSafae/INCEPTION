	...
	<footer class="entry-footer">
		<?php if ( 'post' === get_post_type() ) :
			...
			<div class="entry-meta">
				<?php
				atmospheres__posted_on();
				atmospheres__posted_by();
				atmospheres__entry_footer();			
				?>
			</div><!-- .entry-meta -->
		<?php endif; ?>	
	</footer><!-- .entry-footer -->
	...
	<div class="entry-content">
		...
		the_content( sprintf(
			wp_kses(
				...
				__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'atmospheres' ),
				array(
					'span' => array(
						'class' => array(),
					),
		...
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'atmospheres' ),
			'after'  => '</div>',
		) );
		?>
	</div><!-- .entry-content -->
