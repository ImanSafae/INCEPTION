...
-------------------------------------------------------
    Description:
-------------------------------------------------------
Ascend is a classic theme, built before the Gutenberg block editor was created. While some support has been added for the block editor it's a WordPress legacy theme.
...
Yes, go here: http://docs.kadencewp.com/ascend-free/
...
= Version 1.4.11 | 13th November 2022 =
* Update: WC template notice.
* Fix: Notices with PHP 8.1
* Fix: Lightbox conflict with block gallery.

= Version 1.4.10 | 21st September 2022 =
* Fix: Notices with PHP 8

= Version 1.4.9 | 17th January 2022 =
* Fix: Notices with PHP 8

= Version 1.4.8 | 2nd February 2021 =
* Fix: Issue with woocommerce template.
